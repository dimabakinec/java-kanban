...
import ru.yandex.practicum.tasktracker.service.HttpClientException;
...
//    private HttpResponse<String> response;
    ...
    private void checkResponseCode(HttpResponse<String> response) { // Метод проверяет код ответа.
        try {
            ...
            throw new HttpClientException
                    ("Сервер сообщил о проблеме с запросом. Код состояния: " + exception);
        }
    }
    ...
    private void register() {
        ...
        try {
            ...
            throw new HttpClientException("Не удалось выполнить запрос. Ошибка при регистрации: " + e.getMessage());
        }
    }
